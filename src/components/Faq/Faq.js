              ...
              <Tab.Content>
                ...
                <Tab.Pane eventKey="2">
                  <p className="p-faq-paragraph">
                    ...
                    the complexity of the drawing and its detailing. If the
                    sketch will be very detailed, the cost will be higher. The
                    third factor is the cost of consumables and rent. The master
                    ...
                    *To find out the cost of the tattoo, you need to describe
                    ...
                    choice of the master is an investment in your future tattoo.
                  </p>
                </Tab.Pane>
                <Tab.Pane eventKey="3">
                  <p className="p-faq-paragraph">
                    ...
                    place of the future tattoo. It is conducted as on the skin,
                    ...
                    years and will not harm your health.
                  </p>
                </Tab.Pane>
                <Tab.Pane eventKey="4">
                  <p className="p-faq-paragraph">
                    ...
                    placement of tattooing, the master will do it during the
                    session. If you have dry skin, use moisturizers every day
                    for a week before the tattoo session. And, of course, do not
                    forget about a good mood. It will help you relax and enjoy
                    the process, as well as to help the artist to create the
                    best possible result. By following these simple rules, you
                    will be able to enjoy the result of your tattoo.
                  </p>
                </Tab.Pane>
                <Tab.Pane eventKey="5">
                  <p className="p-faq-paragraph">
                ...
                <Tab.Pane eventKey="7">
                  <p className="p-faq-paragraph">
                    ...
                    describe the idea to a artist in detail or give him a visual
                    references. Do not hesitate to ask questions to get exactly
                    what you want. Choosing a motif for your tattoo can take
                    time, but don't rush. It is important that your tattoo is
                    special to you and has a special meaning. Find your
                    inspiration and make this choice with confidence.
                  </p>
                </Tab.Pane>
                <Tab.Pane eventKey="8">
                  <p className="p-faq-paragraph">
